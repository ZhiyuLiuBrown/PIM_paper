...
Due to its proximity to memory, a memory access from a PIM core is much faster than that from a CPU core.
...
This paper is the first work to examine 
 \emph{concurrent} data structures for PIM. We 
show two main results:
(1) naive PIM data structures \emph{cannot} outperform state-of-the-art concurrent data structures
such as pointer-chasing data structures and FIFO queues,
