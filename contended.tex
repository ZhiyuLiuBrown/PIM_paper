...
design a PIM FIFO queue that can outperform state-of-the-art concurrent FIFO queues, such as the one using flat combining~\cite{Hendler10} and the one using Fetch And Add~\cite{Morrison13}.
