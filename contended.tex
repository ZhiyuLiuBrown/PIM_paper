...
design a PIM FIFO queue that can outperform state-of-the-art concurrent FIFO queues, such as the one using flat combining~\cite{}
 and the one using Fetch And Add~\cite{}.
